                        ...
                        <form:form id="inputForm" cssClass="form-horizontal" action="/content/category/save" method="post" modelAttribute="tbContentCategory">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <form:hidden path="parentId" value="${tbContentCategory.parent.id}" />
                                        <input type="text" class="form-control" id="name" name="id" value="${tbContentCategory.parent.name}" placeholder="Select ParentTitle" readonly="true" />
