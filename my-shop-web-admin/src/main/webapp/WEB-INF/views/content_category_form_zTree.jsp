    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Content ${tbContentCategory.id == null ? "Add New" : "Edit"}</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border text-center">
                            <h3 class="box-title">${tbContentCategory.id == null ? "Add New" : "Edit"}</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="Select ParentTitle" readonly="true" data-toggle="modal" data-target="#modal-default"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <form:input path="name" cssClass="form-control required" placeholder="Enter Name" />
                                        <%--<input type="text" class="form-control" id="inputPhone" name="phone" placeholder="Enter phone">--%>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="sortOrder" class="col-sm-3 control-label">SotrOrder</label>
                                        <%--<label for="inputPhone" class="col-sm-3 control-label">Phone</label>--%>

                                    <div class="col-sm-6">
                                        <form:input path="sortOrder" cssClass="form-control required" placeholder="Enter SotrOrder" />
                                            <%--<input type="text" class="form-control" id="inputPhone" name="phone" placeholder="Enter phone">--%>
                                    </div>
                                </div>
...
$(function (){
    ...
    $("#btn-primary").bind("click", function () {
        ...
        console.log(nodes)
        if (nodes.length == 0) {
            swal("First select the ParentTitle !")
        } else {
            var node = nodes[0];
            //isPaarent=true时，说明是文件夹，可以添加子目录
            if(node.isParent){
                $("#parentId").val(node.parentId);
                $("#name").val(node.name);
                $("#modal-default").modal('hide');
            }
            ////isPaarent=false时，说明是文件，不可以添加子目录
            else {
                swal("ParentTitle must be a folder !")
            }
        }
    });
